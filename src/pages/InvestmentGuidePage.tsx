                    ...
                    <div className="container mx-auto px-4 max-w-5xl">
                        <div className="grid grid-cols-1 md:grid-cols-12 gap-16 items-center">
                            <motion.div
                                ...
                                viewport={{ once: true }}
                                className="md:col-span-4 relative max-w-sm mx-auto md:mx-0"
                            >
                                ...
                                <div className="absolute -bottom-6 -right-6 bg-primary text-white p-6 rounded-3xl shadow-xl hidden lg:block z-20 md:hidden">
                        ...
                        <div className="lg:col-span-7">
                            ...
                            >
                                ...
                                <div className="text-center lg:text-left mb-12">
                                    <h1 className="text-5xl md:text-6xl lg:text-7xl font-display font-bold mb-6 tracking-tighter leading-tight">
                                        Stop Guessing About <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-primary italic underline decoration-primary/30 underline-offset-8">Remodeling Costs</span>
                                    </h1>
                                ...
                                >
                                    <div className="aspect-[4/5] rounded-3xl overflow-hidden shadow-2xl bg-slate-100 border-8 border-white/10 group backdrop-blur-sm">
                                        <img
                                            src="/about-kyle.jpg"
                                            alt="Kyle Stack"
                                            className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-110"
                                    ...
                                    <div className="absolute -bottom-6 -right-6 bg-primary text-white p-6 rounded-3xl shadow-xl hidden sm:block z-20 border border-white/10">
                                        <p className="text-3xl font-display font-bold">15+</p>
                                        <p className="text-sm font-medium opacity-90 uppercase tracking-wider">Years Exp.</p>
                                    </div>
                                </motion.div>
                            </motion.div>
                        </div>
