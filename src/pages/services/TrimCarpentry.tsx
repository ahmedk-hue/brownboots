...
import { PenTool, CheckCircle2, ArrowRight, Calendar, ClipboardCheck, PencilRuler, HardHat, CheckCircle } from 'lucide-react';
        ...
        <div className="bg-white">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-6xl font-display font-bold mb-6 tracking-tight leading-tight">
                            Trim Carpentry for the <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-primary">Way You Actually Live.</span>
                        </h1>
                        <p className="text-xl text-slate-300 leading-relaxed mb-10 max-w-3xl mx-auto">
                            Trusted by Westmoreland County homeowners to add character and value to their homes. Built to last, expertly finished, and handled by local pros.
                        </p>
            ...
            <section className="py-24 bg-white border-b border-slate-50">
                <div className="container mx-auto px-4 max-w-4xl text-center">
                    <h2 className="text-3xl md:text-5xl font-display font-bold text-slate-900 mb-8 tracking-tight">Fine Details, <span className="text-primary">Real Character.</span></h2>
                    <p className="text-xl text-slate-600 leading-relaxed mb-8 italic font-medium">
                        "You don’t need a museum-perfect gallery. You need crown molding that covers those ceiling gaps, baseboards that handle the vacuum cleaner, and built-ins that actually hold your life's treasures."
                    </p>
                    <p className="text-lg text-slate-700 leading-relaxed">
                        At BrownBoot Repairs & Remodeling, we focus on durability and precision that stands up to Westmoreland County seasons. From Irwin to Manor, we help our neighbors add high-end architectural appeal without the high-end ego or pricing games.
                    </p>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-4 lg:gap-8">
                        {[
                            ...
                            { name: "Selections", icon: <PencilRuler />, desc: "We help you pick the right trim styles and handles." },
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-lg text-slate-600 mb-8 leading-relaxed font-medium">
                                We know budget is your top priority. Whether you’re adding crown molding to a single room or upgrading an entire floor's millwork, we provide clear, localized pricing.
                            </p>
                            <div className="space-y-6">
                                <div className="flex items-start gap-4 bg-slate-50 p-6 rounded-2xl border border-slate-100">
                                    <div className="text-2xl font-bold text-primary">ROI Focus</div>
                                    <div>
                                        <h4 className="font-bold text-slate-900">High Impact Details</h4>
                                        <p className="text-sm text-slate-500">New baseboards and trim are often the most cost-effective way to refresh a home's appearance.</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4 bg-slate-50 p-6 rounded-2xl border border-slate-100">
                                    <div className="text-2xl font-bold text-primary">Custom</div>
                                    <div>
                                        <h4 className="font-bold text-slate-900">Built for Success</h4>
                                        <p className="text-sm text-slate-500">Custom mantels and built-ins tailored exactly to your home's unique dimensions.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="bg-slate-900 rounded-[2.5rem] p-10 text-white relative shadow-2xl overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-slate-300 mb-10 leading-relaxed text-lg italic">
                                    "Is your neighbor jealous of your new trim? Refer them and we'll pay you a <strong>3% commission in cash</strong> once finished!"
                                </p>
                                <a
                                    href="/referrals"
            ...
            <section className="py-24 bg-slate-50">
                <div className="container mx-auto px-4 text-center">
                    <h2 className="text-3xl md:text-4xl font-display font-bold text-slate-900 mb-16">2026 Trim & Woodwork Trends</h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            { title: "Layered Moldings", desc: "Moving away from simple 1-piece profiles toward thicker, layered crown and base for an upscale architectural look." },
                            { title: "Natural Accents", desc: "Using White Oak and Walnut accents in built-ins to provide organic warmth alongside painted millwork." },
                            { title: "Shadow Boxes", desc: "Intentional wainscoting and wall paneling that adds depth and sophistication to dining rooms and foyers." }
                        ].map((trend, idx) => (
