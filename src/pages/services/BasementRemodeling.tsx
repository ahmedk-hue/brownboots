        ...
        <div className="bg-white">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-6xl font-display font-bold mb-6 tracking-tight leading-tight">
                            Basement Remodeling for the <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-primary">Way You Actually Live.</span>
                        </h1>
                        <p className="text-xl text-slate-300 leading-relaxed mb-10 max-w-3xl mx-auto">
                            Trusted by Westmoreland County homeowners to turn unfinished basements into essential living spaces. Built to last, designed for versatility, and handled by local pros.
                        </p>
            ...
            <section className="py-24 bg-white border-b border-slate-50">
                <div className="container mx-auto px-4 max-w-4xl text-center">
                    <h2 className="text-3xl md:text-5xl font-display font-bold text-slate-900 mb-8 tracking-tight">Intentional Space, <span className="text-primary">Real Utility.</span></h2>
                    <p className="text-xl text-slate-600 leading-relaxed mb-8 italic font-medium">
                        "You don’t need a cold, open-concept cave. You need a warm, finished area for an office, a playroom that actually contains the chaos, or a guest suite that feels like a natural part of your home."
                    </p>
                    <p className="text-lg text-slate-700 leading-relaxed">
                        At BrownBoot Repairs & Remodeling, we focus on durability and moisture-proof construction that stands up to Westmoreland County seasons. We help you unlock your home's hidden square footage without the stress and delays of impersonal crews.
                    </p>
                </div>
            </section>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-lg text-slate-600 mb-8 leading-relaxed font-medium">
                                We know budget is your top priority. Whether you’re finishing a new build or modernizing an older basement, we help you understand the real costs for Western PA homes so there are no surprises.
                            </p>
                            <div className="space-y-6">
                                <div className="flex items-start gap-4 bg-slate-50 p-6 rounded-2xl border border-slate-100">
                                    <div className="text-2xl font-bold text-primary">$35k-$85k</div>
                                    <div>
                                        <h4 className="font-bold text-slate-900">Finished Living Areas</h4>
                                        <p className="text-sm text-slate-500">Typical range for mid-sized basement finishing including framing and drywall (PA 2026).</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4 bg-slate-50 p-6 rounded-2xl border border-slate-100">
                                    <div className="text-2xl font-bold text-primary">70%+</div>
                                    <div>
                                        <h4 className="font-bold text-slate-900">Value Retention</h4>
                                        <p className="text-sm text-slate-500">Finished basements remain one of the best ways to add appraisal value to your home.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="bg-slate-900 rounded-[2.5rem] p-10 text-white relative shadow-2xl overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-slate-300 mb-10 leading-relaxed text-lg italic">
                                    "Know someone looking to finish their basement? Refer them and we'll pay you a <strong>3% commission in cash</strong> once finished!"
                                </p>
                                <a
                                    href="/referrals"
            ...
            <section className="py-24 bg-slate-50">
                <div className="container mx-auto px-4 text-center">
                    <h2 className="text-3xl md:text-4xl font-display font-bold text-slate-900 mb-16">2026 Basement Design Trends</h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            { title: "Grounded Earth Tones", desc: "Using mushrooms, clays, and soft taupes instead of cool grays for a much warmer, inviting feel below grade." },
                            { title: "Zoned Living", desc: "Building 'Defined Spaces' like reading nooks, homework stations, and home offices over just large open rooms." },
                            { title: "Durable Finishes", desc: "LVP flooring and White Oak accents that provide premium looks with industrial-level moisture durability." }
                        ].map((trend, idx) => (
