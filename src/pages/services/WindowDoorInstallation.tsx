...
import { DoorOpen, CheckCircle2, ArrowRight, Calendar, ClipboardCheck, PencilRuler, HardHat, CheckCircle } from 'lucide-react';
        ...
        <div className="bg-white">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    ...
                    >
                        ...
                        <h1 className="text-4xl md:text-6xl font-display font-bold mb-6 tracking-tight leading-tight">
                            Windows & Doors for the <span className="text-transparent bg-clip-text bg-gradient-to-r from-white via-white to-primary">Way You Actually Live.</span>
                        </h1>
                        <p className="text-xl text-slate-300 leading-relaxed mb-10 max-w-3xl mx-auto">
                            Trusted by Westmoreland County homeowners to improve energy efficiency and security. Built to last, expertly fitted, and handled by local pros.
                        </p>
            ...
            <section className="py-24 bg-white border-b border-slate-50">
                <div className="container mx-auto px-4 max-w-4xl text-center">
                    <h2 className="text-3xl md:text-5xl font-display font-bold text-slate-900 mb-8 tracking-tight">Solid Security, <span className="text-primary">Real Efficiency.</span></h2>
                    <p className="text-xl text-slate-600 leading-relaxed mb-8 italic font-medium">
                        "You don’t need a high-tech fortress. You need windows that don’t rattle in the wind, doors that lock tight when you go to bed, and energy bills that don’t spike every Western PA winter."
                    </p>
                    <p className="text-lg text-slate-700 leading-relaxed">
                        At BrownBoot Repairs & Remodeling, we focus on airtight installation and durable materials that withstand our local elements. From Greensburg to Murrysville, we help our neighbors secure their homes and lower their utility bills without the "hard-sell" tactics of window conglomerates.
                    </p>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-5 gap-4 lg:gap-8">
                        {[
                            ...
                            { name: "Selections", icon: <PencilRuler />, desc: "We help you pick the right energy ratings and hardware." },
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <p className="text-lg text-slate-600 mb-8 leading-relaxed font-medium">
                                We know budget is your top priority. From single door replacements to whole-house window upgrades, we provide transparent project costs tailored to the Western PA market.
                            </p>
                            <div className="space-y-6">
                                <div className="flex items-start gap-4 bg-slate-50 p-6 rounded-2xl border border-slate-100">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-slate-900">Energy Savings</h4>
                                        <p className="text-sm text-slate-500">Modern energy-efficient windows can reduce heating/cooling costs by up to 15%.</p>
                                    </div>
                                </div>
                                <div className="flex items-start gap-4 bg-slate-50 p-6 rounded-2xl border border-slate-100">
                                    <div className="text-2xl font-bold text-primary">Security</div>
                                    <div>
                                        <h4 className="font-bold text-slate-900">Built to Last</h4>
                                        <p className="text-sm text-slate-500">New entry systems with high-grade hardware provide peace of mind for your family.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="bg-slate-900 rounded-[2.5rem] p-10 text-white relative shadow-2xl overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-slate-300 mb-10 leading-relaxed text-lg italic">
                                    "Refer a neighbor for their window or door project, and we'll pay you a <strong>3% commission in cash</strong> once finished!"
                                </p>
                                <a
                                    href="/referrals"
            ...
            <section className="py-24 bg-slate-50">
                <div className="container mx-auto px-4 text-center">
                    <h2 className="text-3xl md:text-4xl font-display font-bold text-slate-900 mb-16">2026 Window & Door Trends</h2>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            { title: "Sleek Dark Frames", desc: "Black and charcoal window frames continue to provide a modern, high-contrast look that pops against local brick." },
                            { title: "Grand Entryways", desc: "Moving toward oversized pivot doors and sidelights that create a major impact for curb appeal." },
                            { title: "Sustainable Tech", desc: "Triple-pane glass becoming the new standard for the best energy performance in our fluctuating climate." }
                        ].map((trend, idx) => (
