      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="bg-gradient-to-br from-slate-900 to-slate-800 p-8 md:p-12 rounded-3xl text-white shadow-xl relative overflow-hidden">
            ...
            <button className="w-full py-4 bg-primary hover:bg-red-600 text-white font-bold rounded-xl transition-colors flex items-center justify-center gap-2 relative z-10">
